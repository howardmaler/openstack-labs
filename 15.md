...
Here is our new Mitaka lab platform. The online instructions were originally written for Ubuntu 14.04 and used as a basis for installation on Ubuntu 16.04.
...
1. Install ubuntu 16.04
    ...
    2) Recommend using a standard password for most development work, remember you can always reset it, *`qwAS12!@`*. The default password policy in ubuntu is 8 characters in length with at least one of the following
