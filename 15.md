...
## 0. Core System Setup For all nodes

#####01. Install ubuntu 16.04
...
7. If you did not install _**openssh-server**_ during the system install, do this now ...
    ...
    ###### NOTE: _Ubuntu 16.04 Installation Complete, cloning the system at this point will allow you to restore quickly in the event of disaster, create a full system clone and not meerly a snapshot ...._
...
#####04. Configure Access without the need for a password
    ...
    2. While in the home directory, generate the rsa keypair
...
#####05. Installing Python 2.7 is necessary because Ubuntu 16.04 ships with python 3.0, however ansible has not been updated and requires Python 2.7
