...
2. Add Default User(s) and Add to Sudoers List
    ...
    ###### NOTE: _You will be prompted to provide a password, use the same password from step 1.3, but you will only need it for a short period of time. Again it can easily changed later ...._
