...
1. Install ubuntu 16.04
	...
	a. `Although you can create any user for your install user we strongly suggest that you use a standardized user. The user of choice for us is ubuntu.  `
	b. `The default password policy in ubuntu is 8 characters in length with at least one of the following 
		* A number
		* A symbol
		* Upper Case Letter 
		* Lower Case Letter
