...
1. Install ubuntu 16.04
    ...
    1) Although you can create any user for your install user we strongly suggest that you use a standardized user. The user of choice for us is **`ubuntu`**.

    2) Recommend using a standard password for most development work, remember you can always reset it, **`qwAS12!@`**. The default password policy for ubuntu is 8 characters in length with at least one of the following
    ...
    3) You can name this system anything, but it is strongly recommended that you name it *`ansible`*


2. The Ansible System will require a static IP address.
