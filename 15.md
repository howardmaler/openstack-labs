...
2. Configure the network and access
    ...
    ###### WARNING: In the above section of the interfaces file, observe that the _**ens160**_ is the name of the device which varies from system to system. DO NOT MODIFY. If you change this the Network Interface will fail.
    ###### NOTE: More Inforation can be attained by doing a Google search on "_predictable network interface names_"

    3) Modify that to Add the following keeing in mind that **en33** is the name of the network interface and varies from system to system, without changing that name
